...
#    print ' '
    ...
    number_small_eq_array   =   zeros(number_eqs)
...
#    n, bins, patches = plt.hist(number_small_eq_array, num_bins, facecolor='green', alpha=0.5)
    ...
    plt.title(r'Regional Earthquake Risk')
    ...
    plt.xlim([0,1])
#   ax4.get_yaxis().set_ticks([0.,.25, .5, .75, 1.0])
...
#    ax4.yaxis.labelpad = 0.5
#    h = ax4.set_ylabel('Cumulative Probability', rotation=270)
#    h.set_rotation(270)
