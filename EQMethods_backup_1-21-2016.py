...
#    print ' '
    ...
    mean    =   mean_val(number_small_eq_array)
    std_deviation, variance = std_var_val(number_small_eq_array)
...
# the histogram of the data
    ...
    #   n, bins, patches = plt.hist(number_small_eq_array, num_bins, normed=1, facecolor='green', alpha=0.5)
...
#    n, bins, patches = plt.hist(number_small_eq_array, num_bins, facecolor='green', alpha=0.5)
    ...
    n, bins = histogram(number_small_eq_array, num_bins)



    # add a 'best fit' line
    y = mlab.normpdf(bins, float(mean_small_EQs), float(std_dev_small_EQs))
...
#    plt.ylabel('Number')
#    plt.title(r'Histogram of Small Earthquakes')

    # Tweak spacing to prevent clipping of ylabel
#    plt.subplots_adjust(left=0.15, wspace=0.2, right=1.0)
